...
def get_df_by_marketcap_volume_grouped_by_days(df_list, minimum_boundry, maximum_boundry):
    frame_length = 0
    X_list = []
#    Y_list = []
    list_to_test = get_tickers_and_dates_indices_within_market_volume_bondries(df_list, minimum_boundry, maximum_boundry)
...
#    df_X, df_Y, test_potential_volatility_list = get_clean_X_Y_percentage_from_df_by_marketcap_volume(clean_df, 1000000, 6000000)
    df_X = get_df_by_marketcap_volume_grouped_by_days(clean_df, lower_limit, upper_limit)
#    print(df_X)
#    print('fomatting df')
