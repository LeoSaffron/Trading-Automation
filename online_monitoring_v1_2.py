...
time_of_trade_start_str = "2020-01-04 09:30:00"
frame_size = 100
...
#        if(is_first_time_passed_certain_minute(newtime, current_test_minute)):
            ...
            fetch_divided_list_of_tickers(ticker_divided_list, date_to_fetch, date_to_fetch, pre_minute_str, next_minute_str, 0.285)
...
s = datetime.now()
#results = filter_price_getter.get_result_ticker_close_price_tuples(time_of_trade_start_str.split(' ')[0], 0.3, 3.0, "stock_data/stocks_2019_2020", 0, 0, minimum_price = 7)
e = datetime.now()
print ( e - s )
